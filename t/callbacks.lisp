...
(test command-callbacks
  ...
  (is (equal '(("a1" "a2" ()) (1 4) 1 "r" 2) (result-from-nvim/s (nvim:call/s t "vim_command" "LispHostCommandRangeLongDeterm! r a1 a2"))))
  (is (equal '(("a1" "a2" ()) (1 4) 1 "r" 2) (result-from-nvim/s (nvim:call/s t "vim_command" "LispHostCommandRangeLongRand! r a1 a2"))))
  (is (equal '(("a1" "a2" ()) (1 4) 1 "r" 2) (result-from-nvim/s (nvim:call/s t "vim_command" "LispHostCommandRangeShortDeterm! r a1 a2"))))
  (is (equal '(("a1" "a2" ()) (1 4) 1 "r" 2) (result-from-nvim/s (nvim:call/s t "vim_command" "LispHostCommandRangeShortRand! r a1 a2"))))
