...
(test command-callbacks
  ...
  (is (equal '(("a1" "a2" ("a3" "a4")) (2 3) NIL "r" 1) (result-from-nvim/s (nvim:call/s t "vim_command" "2,3LispHostCommandRangeLongDeterm r a1 a2 a3 a4"))))
  (is (equal '(("a1" "a2" ("a3" "a4")) (2 3) NIL "r" 1) (result-from-nvim/s (nvim:call/s t "vim_command" "2,3LispHostCommandRangeLongRand r a1 a2 a3 a4"))))
  (is (equal '(("a1" "a2" ("a3" "a4")) (2 3) NIL "r" 1) (result-from-nvim/s (nvim:call/s t "vim_command" "2,3LispHostCommandRangeShortDeterm r a1 a2 a3 a4"))))
  (is (equal '(("a1" "a2" ("a3" "a4")) (2 3) NIL "r" 1) (result-from-nvim/s (nvim:call/s t "vim_command" "2,3LispHostCommandRangeShortRand r a1 a2 a3 a4"))))
  (nvim:call/s t "vim_input" "j")
  (is (equal '(("a1" "a2" ("a3" "a4")) (2 4) T "r" 2) (result-from-nvim/s (nvim:call/s t "vim_command" ".,$LispHostCommandRangeLongDeterm! r a1 a2 a3 a4"))))
  (is (equal '(("a1" "a2" ("a3" "a4")) (2 4) T "r" 2) (result-from-nvim/s (nvim:call/s t "vim_command" ".,$LispHostCommandRangeLongRand! r a1 a2 a3 a4"))))
  (is (equal '(("a1" "a2" ("a3" "a4")) (2 4) T "r" 2) (result-from-nvim/s (nvim:call/s t "vim_command" ".,$LispHostCommandRangeShortDeterm! r a1 a2 a3 a4"))))
  (is (equal '(("a1" "a2" ("a3" "a4")) (2 4) T "r" 2) (result-from-nvim/s (nvim:call/s t "vim_command" ".,$LispHostCommandRangeShortRand! r a1 a2 a3 a4"))))
  (is (equal '(("a1" "a2" ()) (2 2) T "r" 2) (result-from-nvim/s (nvim:call/s t "vim_command" "LispHostCommandRangeLongDeterm! r a1 a2"))))
  (is (equal '(("a1" "a2" ()) (2 2) T "r" 2) (result-from-nvim/s (nvim:call/s t "vim_command" "LispHostCommandRangeLongRand! r a1 a2"))))
  (is (equal '(("a1" "a2" ()) (2 2) T "r" 2) (result-from-nvim/s (nvim:call/s t "vim_command" "LispHostCommandRangeShortDeterm! r a1 a2"))))
  (is (equal '(("a1" "a2" ()) (2 2) T "r" 2) (result-from-nvim/s (nvim:call/s t "vim_command" "LispHostCommandRangeShortRand! r a1 a2"))))
  (nvim:call/s t "vim_input" "gg")
  (is (equal '(("a1" "a2" ("a3" "a4")) 10 NIL "r" 1) (result-from-nvim/s (nvim:call/s t "vim_command" "10LispHostCommandCountLongDeterm r a1 a2 a3 a4"))))
  (is (equal '(("a1" "a2" ("a3" "a4")) 10 NIL "r" 1) (result-from-nvim/s (nvim:call/s t "vim_command" "10LispHostCommandCountLongRand r a1 a2 a3 a4"))))
  (is (equal '(("a1" "a2" ("a3" "a4")) 10 NIL "r" 1) (result-from-nvim/s (nvim:call/s t "vim_command" "10LispHostCommandCountShortDeterm r a1 a2 a3 a4"))))
  (is (equal '(("a1" "a2" ("a3" "a4")) 10 NIL "r" 1) (result-from-nvim/s (nvim:call/s t "vim_command" "10LispHostCommandCountShortRand r a1 a2 a3 a4"))))
  (nvim:call/s t "vim_input" "j")
  (is (equal '(("a1" "a2" ("a3" "a4")) 10 T "r" 2) (result-from-nvim/s (nvim:call/s t "vim_command" "10LispHostCommandCountLongDeterm! r a1 a2 a3 a4"))))
  (is (equal '(("a1" "a2" ("a3" "a4")) 10 T "r" 2) (result-from-nvim/s (nvim:call/s t "vim_command" "10LispHostCommandCountLongRand! r a1 a2 a3 a4"))))
  (is (equal '(("a1" "a2" ("a3" "a4")) 10 T "r" 2) (result-from-nvim/s (nvim:call/s t "vim_command" "10LispHostCommandCountShortDeterm! r a1 a2 a3 a4"))))
  (is (equal '(("a1" "a2" ("a3" "a4")) 10 T "r" 2) (result-from-nvim/s (nvim:call/s t "vim_command" "10LispHostCommandCountShortRand! r a1 a2 a3 a4"))))
...
(test function-callbacks
  ...
  ; (signals error     (nvim:call/s t "vim_call_function" "LispHostFunArgs" #()))
  ; (signals error     (nvim:call/s t "vim_call_function" "LispHostFunArgs" '(1)))
